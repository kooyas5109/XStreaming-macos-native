...
func compatibilityPlayerPageBootstrapsXStreamingPlayer() throws {
    ...
    #expect(html.contains("startup timeout"))
    #expect(html.contains("video startup timeout"))
    #expect(!html.contains("!player || !remoteOfferApplied || connected"))
    ...
    #expect(html.contains("sendGamepadInput"))
    #expect(html.contains("native gamepad state sent"))
    #expect(html.contains("native keyboard state changed"))
    #expect(html.contains("installNativeKeyboardGamepad"))
    #expect(html.contains("nativeKeyboardGamepadState"))
    #expect(html.contains("LeftThumbYAxisPlus"))
